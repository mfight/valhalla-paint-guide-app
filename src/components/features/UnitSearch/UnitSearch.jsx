...
const UnitSearch = ({
  ...
  const [selectedBuildingType, setSelectedBuildingType] = useState(externalBuildingType || 'All');
  ...
  const filteredUnits = useMemo(() => {
	return units.filter(unit => {
	  ...
	  const matchesBuildingType = selectedBuildingType === 'All' || 
  ...
  const hasActiveFilters = searchTerm.trim() !== '' || selectedBuildingType !== 'All';
...
export const useUnitSearch = (units = []) => {
  ...
  const searchControls = {
	...
	hasActiveFilters: searchTerm.trim() !== '' || selectedBuildingType !== 'All'
  };
