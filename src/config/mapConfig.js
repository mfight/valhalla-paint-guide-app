...
export const getTileConfig = (isDarkMode = false) => {
  const tileKey = isDarkMode ? MAP_CONFIG.defaultDarkTile : MAP_CONFIG.defaultLightTile;
...
export const getMarkerColor = (buildingType) => {
  return MAP_CONFIG.markerColors[buildingType] || MAP_CONFIG.markerColors.default;
};